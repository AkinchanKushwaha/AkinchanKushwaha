...
const DARK = {
  ...
  shadow: 'rgba(0,0,0,.35)', feet: '#1c232c',
};
...
const LIGHT = {
  ...
  shadow: 'rgba(31,35,40,.16)', feet: '#b3bec8',
};
...
function svg(p, count) {
  ...
  <path d="M440,262 C470,262 476,280 478,300 C480,352 486,400 520,412 C536,417 544,414 558,414"
    ...
    stroke-dasharray="4 10" style="animation:flow .9s linear infinite"/>
  ...
  <text x="${j.x + 11}" y="107" text-anchor="middle" font-size="${j.glyph.length > 1 ? 7.5 : 10}" font-weight="700" fill="${p.keyText}">${j.glyph}</text>`).join('')}
  ...
  <g clip-path="url(#glassClip)">
    ...
    <path d="M198,230 q-4,-7 0,-13 q4,-6 0,-12" fill="none" stroke="${p.warm}" stroke-width="1.6" stroke-linecap="round" opacity="0" style="animation:steam 3.6s ease-out .5s infinite"/>
    <path d="M223,230 q4,-7 0,-13 q-4,-6 0,-12" fill="none" stroke="${p.warm}" stroke-width="1.6" stroke-linecap="round" opacity="0" style="animation:steam 3.6s ease-out 2.2s infinite"/>
  </g>
  ...
  <g transform="translate(452,144) rotate(-8)">
    <text x="0" y="0" font-size="13" font-weight="700" fill="${p.ding}" opacity="0" class="pop" style="animation:ding 2.4s ease-out 2.6s both">✦ ding!</text>
  </g>
